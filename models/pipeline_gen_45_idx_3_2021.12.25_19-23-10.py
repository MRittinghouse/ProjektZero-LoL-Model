...
# Average CV score on the training set was: 0.6539956695194477
exported_pipeline = make_pipeline(
    make_union(
        ...
        make_pipeline(
            StackingEstimator(estimator=SGDClassifier(alpha=0.01, eta0=1.0, fit_intercept=True, l1_ratio=0.75, learning_rate="constant", loss="squared_hinge", penalty="elasticnet", power_t=0.5)),
            MinMaxScaler()
        )
    ),
